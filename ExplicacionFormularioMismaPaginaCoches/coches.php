...
{ ?>
    <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
        ...
        <p>Combustible: <input type="radio" name="com" value="Diesel" <?php if ($com == "Diesel")
            echo "checked" ?> /> Diesel
                <input type="radio" name="com" value="Gasolina" <?php if ($com == "Gasolina")
            echo "checked" ?> /> Gasolina
                <input type="radio" name="com" value="Eléctrico/Híbrido" <?php if ($com == "Eléctrico/Híbirdo")
            echo "checked" ?> /> Eléctrico/Híbrido
            </p>
