...
<body>
    <form action="./agente.php" enctype="multipart/form-data" method="post">
        <pre>
        Nombre completo*: <input required type="text" name="nombre"/>

        Nombre de usuario*: <input required type="text" name="usuario"/>

        Contraseña*: <input required type="text" name="contraseña"/>
